$(document).ready(function (e) {
    ...
    $('.is-arrow-down a').click(function (e) {
        if ($(this).parents(".is-section").next().html()) {
            $('html,body').animate({
                scrollTop: $(this).parents(".is-section").next().offset().top - parseInt($('.is-wrapper').css('padding-top')) + 1 /*Adjustment due to topbar height*/
            }, 800);
        }
        e.preventDefault();
